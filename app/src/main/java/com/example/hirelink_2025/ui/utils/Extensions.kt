...
fun Fragment.showSuccessSnackbar(message: String) {
    ...
    snackbar.setBackgroundTint(ContextCompat.getColor(requireContext(), android.R.color.holo_green_light))
    snackbar.show()
}
...
fun Fragment.showErrorSnackbar(message: String, retryAction: (() -> Unit)? = null) {
    ...
    snackbar.setBackgroundTint(ContextCompat.getColor(requireContext(), android.R.color.holo_red_light))
    if (retryAction != null) {
