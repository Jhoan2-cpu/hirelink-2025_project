package com.example.hirelink_2025.ui.fragments
...
import com.example.hirelink_2025.ui.adapters.CategoriesAdapter
import com.example.hirelink_2025.ui.adapters.JobsAdapter
...
class JobsFragment : Fragment() {
    ...
    private fun setupSearchView() {
        view?.findViewById<androidx.appcompat.widget.SearchView>(R.id.searchView)?.apply {
    ...
    private fun navigateToJobDetail(job: JobAd) {
        try {
            ...
            android.util.Log.e("JobsFragment", "Navigation error", e)
        }
    }
}