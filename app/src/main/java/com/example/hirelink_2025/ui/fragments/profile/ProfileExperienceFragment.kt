 ...
 * Use the [ProfileExperienceFragment.newInstance] factory method to
...
class ProfileExperienceFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ProfileExperienceFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ProfileExperienceFragment().apply {
